...
local keys = {
  ...
  { "<leader>fh", function() require "fzf-lua".history({ cwd = vim.uv.cwd(), cwd_header = true, cwd_only = true, include_current_session = true }) end, desc = "Oldfiles (cwd)" },
  ...
  { "<leader>gr", function() require "fzf-lua".git_reflog() end, desc = "Git Reflog" },
  ...
  { "<leader>fs", function() require "fzf-lua".serverlist() end, desc = "Neovim servers", mode = { "n", "v" } },
  ...
  { "<leader>yr", function() require "fzf-lua".git_reflog(vim.tbl_extend("force", yadm_git_opts, { prompt = "YadmReflog> " })) end, desc = "Yadm Reflog" },
