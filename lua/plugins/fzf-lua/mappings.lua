...
local keys = {
  ...
  { "<C-p>", function() require("fzf-lua").frecency({ display_score = true, cwd_only = true, fzf_opts = { ["--no-sort"] = false } }) end, desc = "Frecency (project)" },
  ...
  { "<leader>fH", function() require("fzf-lua").frecency({ display_score = true }) end, desc = "Frecency (All)" },
  { "<leader>fh", function() require("fzf-lua").frecency({ display_score = true, cwd_only = vim.fn.expand("$HOME") ~= vim.uv.cwd() and true }) end, desc = "Frecency (cwd)" },
  -- git
