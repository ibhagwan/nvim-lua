...
vim.cmd('hi link DiagnosticVirtualTextHint    LspDiagnosticsDefaultHint')
  ...
  h('htmlH1',             { fg = dark_blue, gui = 'bold', cterm = 'bold' })
  h('htmlH2',             { fg = dark_blue, gui = 'bold', cterm = 'bold' })
  h('htmlH3',             { fg = blue })
  h('htmlH4',             { fg = blue })
  h('htmlH5',             { fg = dark_cyan })
  h('htmlH6',             { fg = dark_cyan })
  ...
  h('markdownH1',                { fg = dark_blue, gui = 'bold', cterm = 'bold' })
  h('markdownH2',                { fg = dark_blue, gui = 'bold', cterm = 'bold' })
  h('markdownH3',                { fg = dark_blue })
  h('markdownH4',                { fg = dark_blue })
  h('markdownH5',                { fg = dark_cyan })
  h('markdownH6',                { fg = dark_cyan })
  ...
  -- nvim-cmp
  h("CmpItemMenu",              { fg = blue })
  h("CmpItemAbbr",              { fg = blue })
  h("CmpItemAbbrDeprecated",    { fg = comment_grey })
  h("CmpItemAbbrMatch",         { fg = red })
  h("CmpItemAbbrMatchFuzzy",    { fg = purple })
  h("CmpItemKindDefault",       { fg = purple })
  h("CmpItemKindText",          { fg = white })
  h("CmpItemKindMethod",        { fg = red })
  h("CmpItemKindFunction",      { fg = red })
  h("CmpItemKindConstructor",   { fg = dark_blue })
  h("CmpItemKindField",         { fg = purple })
  h("CmpItemKindVariable",      { fg = green })
  h("CmpItemKindClass",         { fg = blue })
  h("CmpItemKindInterface",     { fg = blue })
  h("CmpItemKindModule",        { fg = blue })
  h("CmpItemKindProperty",      { fg = fg })
  h("CmpItemKindUnit",          { fg = fg })
  h("CmpItemKindValue",         { fg = yellow })
  h("CmpItemKindEnum",          { fg = dark_yellow })
  h("CmpItemKindKeyword",       { fg = yellow })
  h("CmpItemKindSnippet",       { fg = dark_yellow })
  h("CmpItemKindColor",         { fg = white })
  h("CmpItemKindFile",          { fg = fg })
  h("CmpItemKindReference",     { fg = purple })
  h("CmpItemKindFolder",        { fg = fg })
  h("CmpItemKindEnumMember",    { fg = yellow })
  h("CmpItemKindConstant",      { fg = yellow })
  h("CmpItemKindStruct",        { fg = blue })
  h("CmpItemKindEvent",         { fg = green })
  h("CmpItemKindOperator",      { fg = dark_cyan })
  h("CmpItemKindTypeParameter", { fg = dark_blue })
