...
hl.c = {
  ...
  space1         = o.space1         or { gui = '#1e1c31', cterm = '233',  cterm16 = 'NONE' },
  space2         = o.space2         or { gui = '#2D2B40', cterm = '233',  cterm16 = 'NONE' },
  space3         = o.space3         or { gui = '#3E3869', cterm = '236',  cterm16 = '8' },
  space4         = o.space4         or { gui = '#585273', cterm = '236',  cterm16 = '8' },
}
...
hl.common = {
  ...
  IncSearch =         { fg = hl.c.black, bg = hl.c.yellow },
  ...
  ModeMsg =           { fg = hl.c.comment_grey, gui = 'bold', cterm = 'bold' },
  MoreMsg =           { fg = hl.c.comment_grey, gui = 'bold', cterm = 'bold' },
...
hl.syntax = {
  ...
  Keyword =           { fg = hl.c.green },
  Statement =         { fg = hl.c.purple },
  Conditional =       { fg = hl.c.green },
...
hl.lsp = {
  ...
  DiagnosticUnderlineError            = { sp = hl.c.red,    gui = 'underline', cterm = 'underline' },
